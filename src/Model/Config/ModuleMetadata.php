...
namespace MagePsycho\DisableRegistration\Model\Config;
...
class ModuleMetadata implements ModuleMetadataInterface
{
    ...
    const PRODUCT_NAME = 'Disable Registration';

    const PRODUCT_URL = 'https://www.magepsycho.com/magento2-disable-customer-registration.html';

    const MODULE_NAME = 'MagePsycho_DisableRegistration';

    const VERSION_CACHE_KEY = 'magepsycho-disableregistration-module-version';
