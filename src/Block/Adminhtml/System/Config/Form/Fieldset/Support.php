...
namespace MagePsycho\DisableRegistration\Block\Adminhtml\System\Config\Form\Fieldset;

use Magento\Backend\Block\Template;
use Magento\Backend\Block\Template\Context;
use Magento\Framework\Data\Form\Element\AbstractElement;
use MagePsycho\DisableRegistration\Model\Config\ModuleMetadata;
...
class Support extends Template implements RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'MagePsycho_DisableRegistration::system/config/form/fieldset/support.phtml';
